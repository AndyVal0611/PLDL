...
# Create and instantiate the UserAccountApplication class
app = UserAccountApplication(window)

# Initialize labels and textboxes from create_label_entry under UserAccountApp class, that will create 3 rows
# First row
