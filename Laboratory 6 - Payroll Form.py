...
window = tk.Tk()
window.title("AV Paper N' Pixels Payroll")
...
class PayrollForm:
    def __init__(self):
        # Header Section
        self.header = tk.Label(window, text="AV Paper N' Pixels", bg="#ebd469", fg="black", font=("Century Gothic", 20, "bold"))
    ...
    def create_employee_basic_info_section(self):
        ...
        self.basic_info_frame = tk.LabelFrame(self.main_frame, text="EMPLOYEE BASIC INFO:", bg="light yellow", font=("tahoma", 12, "bold"))
        ...
        # Employee Number
        self.employee_number_label = tk.Label(self.basic_info_frame, text="Employee Number:", bg="light yellow", font=("tahoma", 10))
