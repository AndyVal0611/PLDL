...
#windows
window = tk.Tk()
image = Image.open('C:\\Users\\valde\\Documents\\GitHub\\LAB-3-FILES---VALDEZ\\LAB-3-FILES---VALDEZ\\IMAGES\\Profile.jpg')
bck_pic = ImageTk.PhotoImage(image.resize((1550, 900)))
