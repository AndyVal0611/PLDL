...
class Billing_Summary:
        def __init__(self):
            ...
            self.msc = msc
            self.total_current_charges_before_taxes = total_current_charges_before_taxes
            self.government_taxes = government_taxes
            self.rate = rate
            self.consumption_cubic_meter = consumption_cubic_meter
            self.payment_due_date = payment_due

            # compute the following charges, including basic, environmental, total current before tax, and government, tax
            self.basic_charge = rate * consumption_cubic_meter
